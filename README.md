# Questões do Terceiro Trabalho da Disciplina de POO - 2023.1

Repositório destinado às atividades do terceiro trabalho da disciplina de Programação Orientada a Objetos do P3 de informática ministrada pelo professor Roger Moura.
...
**Descrição**
<br>
O terceiro trabalho consiste em questões para serem resolvidas na linguagem Java que buscam dar um conhecimento básico a como utilizar estruturas de repetição, como for, while e do-while.
<br>
